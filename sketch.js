...
function mouseClicked(){
	if(mouseX >= 34 && mouseX < 84){
		if(mouseY >= 7 && mouseY < 29){
			init();
			begin=true;
		}
	}
	if(mouseX >= 102 && mouseX < 267){
		if(mouseY >= 7 && mouseY < 29){
			randomizeColours();
		}
	}
	if(mouseX >= 282 && mouseX < 394){
		if(mouseY >= 7 && mouseY < 29){
			resetPuzzle();
		}
	}
...
// Touch events
function touchEnded(){
	if(touchX >= 34 && touchX < 84){
		if(touchY >= 7 && touchY < 29){
			init();
			begin=true;
		}
	}
	if(touchX >= 102 && touchX < 267){
		if(touchY >= 7 && touchY < 29){
			randomizeColours();
		}
	}
	if(touchX >= 282 && touchX < 394){
		if(touchY >= 7 && touchY < 29){
			resetPuzzle();
		}
	}
...
function draw(){
	...
	text("Begin", gOffsetX,24);
	text("Randomize Colours", gOffsetX+70,24);
	text("Reset Puzzle", gOffsetX+250,24);
	// Check complete
	if(begin){
		compute();
		if(solvedCount == 81){
